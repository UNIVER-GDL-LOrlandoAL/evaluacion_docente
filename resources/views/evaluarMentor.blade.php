    ...
    <form method="POST" action="{{ route('principal.store') }}" aria-label="{{ __('Evaluacion') }}" enctype="multipart/form-data">
        ...
        <div class="py-6">
            ...
            @if(isset($coordinadores) && $coordinadores->isNotEmpty())
                ...
                <input type="hidden" name="coordinador" value="{{ $coordinadores->first()->nombre }}">
                        ...
                        <table class="min-w-full table-auto">
                            ...
                            <tbody class="bg-gray-200">
                                <tr class="bg-white border-2 border-gray-200">
                                    ...
                                    <td><input required type="radio" value="1" name="resultado_coordinador" class="form-radio h-5 w-5 text-blue-600"></td>
                                </tr>
                                <tr class="bg-white border-2 border-gray-200">
                                    <td class="px-4 sm:px-16 py-3"><span class="text-center ml-2 font-semibold text-gray-500">Regular</span></td>
                                    <td><input required type="radio" value="2" name="resultado_coordinador" class="form-radio h-5 w-5 text-blue-600"></td>
                                </tr>
                                <tr class="bg-white border-2 border-gray-200">
                                    <td class="px-4 sm:px-16 py-3"><span class="text-center ml-2 font-semibold text-gray-500">Bueno</span></td>
                                    <td><input required type="radio" value="3" name="resultado_coordinador" class="form-radio h-5 w-5 text-blue-600"></td>
                                </tr>
                                <tr class="bg-white border-2 border-gray-200">
                                    <td class="px-4 sm:px-16 py-3"><span class="text-center ml-2 font-semibold text-gray-500">Muy Bueno</span></td>
                                    <td><input required type="radio" value="4" name="resultado_coordinador" class="form-radio h-5 w-5 text-blue-600"></td>
                                </tr>
                                <tr class="bg-white border-2 border-gray-200">
                                    <td class="px-4 sm:px-16 py-3"><span class="text-center ml-2 font-semibold text-gray-500">Excelente</span></td>
                                    <td><input required type="radio" value="5" name="resultado_coordinador" class="form-radio h-5 w-5 text-blue-600"></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            @else
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-4 text-center">
                    ...
                    <input type="hidden" name="coordinador" value="No Asignado">
                    <input type="hidden" name="resultado_coordinador" value="0">
        ...
        <div class="py-6">
            ...
            @if(isset($mentores) && $mentores->isNotEmpty())
                ...
                <input type="hidden" name="mentor" value="{{ $mentores->first()->nombre }}">
                    ...
                    <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                        <table class="min-w-full table-auto">
                            ...
                            <tbody class="bg-gray-200">
                                <tr class="bg-white border-2 border-gray-200">
                                    <td class="px-4 sm:px-16 py-3"><span class="text-center ml-2 font-semibold text-gray-500">Malo</span></td>
                                    <td><input required type="radio" value="1" name="resultado_mentor" class="form-radio h-5 w-5 text-blue-600"></td>
                                </tr>
                                <tr class="bg-white border-2 border-gray-200">
                                    <td class="px-4 sm:px-16 py-3"><span class="text-center ml-2 font-semibold text-gray-500">Regular</span></td>
                                    <td><input required type="radio" value="2" name="resultado_mentor" class="form-radio h-5 w-5 text-blue-600"></td>
                                </tr>
                                <tr class="bg-white border-2 border-gray-200">
                                    <td class="px-4 sm:px-16 py-3"><span class="text-center ml-2 font-semibold text-gray-500">Bueno</span></td>
                                    <td><input required type="radio" value="3" name="resultado_mentor" class="form-radio h-5 w-5 text-blue-600"></td>
                                </tr>
                                <tr class="bg-white border-2 border-gray-200">
                                    <td class="px-4 sm:px-16 py-3"><span class="text-center ml-2 font-semibold text-gray-500">Muy Bueno</span></td>
                                    <td><input required type="radio" value="4" name="resultado_mentor" class="form-radio h-5 w-5 text-blue-600"></td>
                                </tr>
                                <tr class="bg-white border-2 border-gray-200">
                                    <td class="px-4 sm:px-16 py-3"><span class="text-center ml-2 font-semibold text-gray-500">Excelente</span></td>
                                    <td><input required type="radio" value="5" name="resultado_mentor" class="form-radio h-5 w-5 text-blue-600"></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            @else
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-4 text-center">
                    ...
                    <input type="hidden" name="mentor" value="No Asignado">
                    <input type="hidden" name="resultado_mentor" value="0">
